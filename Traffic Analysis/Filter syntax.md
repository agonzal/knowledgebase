...
True if the IPv4/v6 destination address of the packet has a network number of `net`, may be either a name from the networks database (`/etc/networks`, etc.) or a network number.  
